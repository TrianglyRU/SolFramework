...
{	
	...
	case 2:
		...
		switch (option_id)
		{
			...
			case 1: room_to_load = rm_stage_tsz1; break;
			case 2: room_to_load = rm_stage_tsz2; break;
			case 3: room_to_load = rm_bonus; break;
			case 4: room_to_load = rm_special; break;
			case 5: room_to_load = rm_continue; break;
