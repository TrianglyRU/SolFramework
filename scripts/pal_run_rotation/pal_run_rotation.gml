/// @self
/// @description Rotates the "global" palette colours of the given indexes.
...
function pal_run_rotation(_colour_indexes, _duration, _loop_index, _end_index)
{
	with (obj_framework)
	{
		for (var _i = array_length(_colour_indexes) - 1; _i >= 0; _i--)
		{
			var _index = _colour_indexes[_i];
