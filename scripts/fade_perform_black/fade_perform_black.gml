...
function fade_perform_black(_direction, _step_duration, _fade_action = undefined, _game_control = true)
{
	var _speed = _step_duration > 0 ? (1 / _step_duration) : 0;
	var _type = _direction == FADE_DIRECTION.IN ? FADE_TYPE.BLACK_SYNC : FADE_TYPE.BLACK_ORDER;
