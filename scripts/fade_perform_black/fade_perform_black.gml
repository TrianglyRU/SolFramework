...
function fade_perform_black(_routine, _step_duration, _game_control = true)
{
	var _speed = _step_duration > 0 ? (1 / _step_duration) : 0;
	
	fade_perform
	(
		_routine, _routine == FADEROUTINE.IN ? FADETYPE.BLACKSYNC : FADETYPE.BLACKORDER, _speed, _step_duration, _game_control
	);
}