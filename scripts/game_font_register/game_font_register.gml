...
/// @param {Real} _cut_empty_space Whether to trim empty space around characters (requires "Automatically Crop" enabled in Texture Group Settings).
/// @param {Real} _separation The spacing between individual characters in the font.
function game_font_register(_sprite_id, _map_string, _cut_empty_space, _separation)
{
