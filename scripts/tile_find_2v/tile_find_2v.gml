...
/// @returns {Array<Real>}
function tile_find_2v(_x1, _y1, _x2, _y2, _dir, _secondary_layer, _quadrant = QUADRANT.DOWN)
{
	var _tile_data1 = tile_find_v(_x1, _y1, _dir, _secondary_layer, _quadrant);
	var _tile_data2 = tile_find_v(_x2, _y2, _dir, _secondary_layer, _quadrant);
