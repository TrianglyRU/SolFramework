/// @self
/// @description The same as regular instance_create() function, but makes a new object to dependent on the object the function was called from to handle the culling properly.
...
/// @returns {Id.Instance}
function instance_create_dependent(_x, _y, _object, _vars = {})
{
